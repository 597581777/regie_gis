 ...
 * @since 1.0
 */
public interface TLicRlicInfoService {
	
	/**
	 * 查询零售户信息
	 */
	TLicRlicInfo findLicInfoById(String licUuid);
	 ...
	 */
	int updateLicInfoLocalById(LicQueryQm licQueryQm);

	/**
	 * 
	 * <p>Description: 根据许可证号获取详细信息列表<p>
	 * @param licNos
	 * @return
	 * @author haoyajie 2017-10-19
	 */
	List<TLicRlicInfo> findLicInfoList(String licNos);

	/**
	 * <p>Description: 根据许可证号查询许可证信息<p>
	 * @param licNo
	 * @return
	 * @author haoyajie 2017-10-19
	 */
	TLicRlicInfo findLicInfoByLicNo(String licNo);
}